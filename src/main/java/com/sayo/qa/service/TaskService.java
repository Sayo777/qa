...
public class TaskService {
    ...
    public List<Task> findFinishedTaskByQaEid(int qaeId, int offset, int limit) {
        return taskMapper.findFinishedTaskByQaEid(qaeId, offset, limit);
    }

    public int findRowsFinishedTaskByQaEid(int qaeId) {
        return taskMapper.findRowsFinishedTaskByQaEid(qaeId);
    }
    ...
    public List<Task> findhasAssignTaskByEid(int eId,int offset,int limit) {
        return taskMapper.findhasAssignTaskByEid(eId,offset,limit);
    }

    public int findRowshasAssignTaskByEid(int eId) {
        return taskMapper.findRowshasAssignTaskByEid(eId);
    }

    public List<Task> findfinishAssignTaskByEidAndStatus(int eId, int status,int offset,int limit) {

        return taskMapper.findfinishAssignTaskByEidAndStatus(eId, status,offset,limit);
    }
    public int findRowsfinishAssignTaskByEidAndStatus(int eId, int status) {

        return taskMapper.findRowsfinishAssignTaskByEidAndStatus(eId, status);
    }
